        ...
        <div class="modal-content modal-order">
            ...
            <form name="order" method="post" class="form-horizontal" action="{{ url('/order') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 form-inline">
                        @if(isset($user->profile) && $user->profile->type_client_id)
                            <input type="radio" class="form-control type_user"
                                   @if($user->profile->type_client_id == 1) checked @endif disabled> частное лицо
                            <input type="radio" class="form-control type_company"
                                   @if($user->profile->type_client_id == 2) checked @endif disabled> организация
                            <input type="hidden" name="order_type_client" value="{{ $user->profile->type_client_id }}">
                        @else
                            <input type="radio" class="form-control type_user" name="order_type_client" value="1"
                                   checked> частное лицо
                            <input type="radio" class="form-control type_company" name="order_type_client" value="2">
                            организация
                        @endif
                    </div>
                </div>
                <div class="form-group{{ $errors->has('order_name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" name="order_client_name"
                               value="{{ $user->profile->client_name or '' }}"
                ...
                <div class="form-group client_company_order{{ $errors->has('order_user_company') ? ' has-error' : '' }}"
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" name="order_user_company"
                               value="{{ $user->profile->user_company or '' }}"
                ...
                <div class="form-group{{ $errors->has('order_email') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" name="order_email" value="{{ $user->email or '' }}"
                ...
                <div class="form-group{{ $errors->has('order_address') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <div class="col-md-6" style=" padding:5px">
                            <input type="text" class="form-control" name="order_delivery_town"
                                   value="{{$user->profile->delivery_town or ''}}" required
                    ...
                    <div class="col-md-9">
                        <div class="col-md-6" style=" padding:5px">
                            <input type="text" class="form-control" name="order_delivery_street"
                                   value="{{$user->profile->delivery_street or ''}}" required placeholder="улица">
                            <label class="control-label label1">улица<span class="red">*</span></label>
                        </div>
                        <div class="col-md-2" style=" padding: 5px">
                            <input type="text" class="form-control" name="order_delivery_house"
                                   value="{{$user->profile->delivery_house or ''}}" required placeholder="номер">
                            <label class="control-label label1">дом<span class="red">*</span></label>
                        </div>
                        <div class="col-md-2" style=" padding: 5px">
                            <input type="text" class="form-control" name="order_delivery_house_block"
                                   value="{{$user->profile->delivery_house_block or ''}}" placeholder="корпус">
                            <label class="label1">корпус</label>
                        </div>
                        <div class="col-md-2" style=" padding: 5px">
                            <input type="text" class="form-control" name="order_delivery_office"
                                   value="{{$user->profile->delivery_office or ''}}" placeholder="квартира">
                ...
                <div class="client_company_order"
                    ...
                    <div class="form-group{{ $errors->has('fio') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-9 form-inline">
                            <input type="radio" id="payment_nal" class="form-control" name="order_type_payment"
                                   value="1"
                                   @if((isset($user->profile) && $user->profile->type_payment_id == 1) || !isset($user->profile)) checked @endif>
                            наличный расчет
                            <input type="radio" id="payment_b_nal" class="form-control" name="order_type_payment"
                                   value="2"
                                   @if(isset($user->profile) && $user->profile->type_payment_id == 2) checked @endif>
                            безналичный расчет
                            <input type="radio" id="payment_nds" class="form-control" name="order_type_payment"
                                   value="3"
                ...
                <div class="form-group{{ $errors->has('order_comment') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <textarea class="form-control" name="order_comment"
