    ...
    <div class="content-page">
        ...
        <form name="order_order" method="post" class="form-horizontal" action="{{ url('/order') }}">
            ...
            <div class="form-group{{ $errors->has('order_phone') ? ' has-error' : '' }}">
                ...
                <div class="col-md-9">
                    <input  type="text" class="form-control" name="order_phone" value="@if(old()){{ old('order_phone') }}@else{{ $order->order_phone or '' }}@endif" placeholder="номер мобильного телефона (050xxxxxxx)">
