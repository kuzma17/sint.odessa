                        ...
                        <!--<div class="form-group" style="border-bottom: 1px solid #cccccc">
                            ...
                            <div class="col-md-6" style="padding: 6px">
                                ...
                                <div class="social-buttons2">
                                    <a href="{{ url('/social/facebook') }}" class="btn btn-fb"><i
                                                class="fa fa-facebook"></i> Facebook</a>
                                    <a href="{{ url('/social/twitter') }}" class="btn btn-tw"><i
                                ...
                                <!-- <a href="{{ url('/social/odniklassniki') }}" class="btn btn-od"><i class="fa fa-odnoklassniki"></i> Odniklassniki</a>
                                    ...
                                    <!--<a href="{{ url('/social/google') }}" class="btn btn-go"><i
                                                class="fa fa-google"></i> Google</a>
                                    <a href="{{ url('/social/github') }}" class="btn btn-git"><i class="fa fa-github"
                                                                                                 aria-hidden="true"></i>
                                        Github</a>
                                </div>
